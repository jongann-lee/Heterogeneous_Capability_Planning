...
Usage
-----
    from planning.legacy import scout_gtsp
    from simulation.engine import run_simulation
    run_simulation(env_map, ground_truth, agents, policy=scout_gtsp.replan)
    # or with knobs:
...
from simulation.domain import SCOUT, UNKNOWN_TYPE, beats, TYPE_NAMES
...
# ---------------------------------------------------------------------------
# Policy factory / entry point (matches the simulation engine's signature).
# ---------------------------------------------------------------------------
